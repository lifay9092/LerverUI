...
//
//class LerverTreeViewRRRR<T : Any, P : Any> : TreeView<T> {
//    constructor()
...
//    var TREE_DATA_CALL: Supplier<List<T>>? = null
//
////    var TREE_IMG_CALL: ((TreeItem<T>) -> Unit)? = null
//    var TREE_IMG_CALL: Consumer<TreeItem<T>>? = null
//
...
//        init: Boolean = false,
//        imgCall: Consumer<TreeItem<T>>? = null,
//        initDataCall: Supplier<List<T>>
//    ) {
//        //判断
...
//         getInitDataCall: Supplier<List<T>>
//    ) {
...
//        filterFunc: Function<T,Boolean>? = null
//    ) {
//        asyncTask {
//            //println("RefreshTree")
//
...
//                    item
//                }.filter {
//                    if (filterFunc == null || filterFunc.apply(it.value)) {
//                        return@filter true
//                    }
...
//            }.map {
//                val item = createTreeItem(it)
//                TREE_IMG_CALL?.let { it1 -> it1.accept(item) }
//
...
//               // this.treeView = this@LerverTreeViewRRRR
//                initTreeItem(this)
//            }
//        } else {
//            TreeItem(it).apply {
...
//
//        TREE_IMG_CALL?.let { it.accept(treeItem) }
//    }
//
//    /**
//     * 清除TreeItem相应的缓存
